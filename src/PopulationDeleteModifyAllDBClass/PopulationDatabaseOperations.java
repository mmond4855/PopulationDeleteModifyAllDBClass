...
public class PopulationDatabaseOperations 
{
    ...
    private static String dbDirectory = "F:/CIS2206 - Business Programming I/";
    ...
    {
        String modifyStatement = "UPDATE POPULATION SET TOWN_NAME = ? "
                                + "WHERE TOWN_NUMBER = ? ";
        try(Connection connection1 = openConnection())
        {
    ...
    {
        String modifyStatement = "UPDATE POPULATION SET COUNTY_NUMBER = ? "
                                + "WHERE TOWN_NUMBER = ? ";
        try(Connection connection1 = openConnection())
        {
            PreparedStatement statement = connection1.prepareStatement(modifyStatement);
    ...
    {
        String modifyStatement = "UPDATE POPULATION SET REGION_NUMBER = ? "
                                + "WHERE TOWN_NUMBER = ? ";
        try(Connection connection1 = openConnection())
        {
            PreparedStatement statement = connection1.prepareStatement(modifyStatement);
